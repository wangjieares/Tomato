 ...
 */
public class LoadingCustom extends View {
    ...
    public LoadingCustom(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingCustom(Context context, AttributeSet attrs, int defStyleAttr) {
 ...
 */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mProgressLoadingWidth = mProgressMaxWidth * mProgressTest;
        ...
        if (mProgressTest <= mOneArcProgress) {
            drawLeftArc(canvas);

        } else if (mProgressTest > mOneArcProgress && mProgressTest <= (1 - mOneArcProgress)) {
            drawLeftArc(canvas);
